const parts = [
   "Хвост руководит настроением кота, диктует ему направление движения, эмоции и даже периодически подсказывает мурчащему аппарату, как наиболее выгодным образом раскрутить хозяина на еду.",
    ...
    "Мордочка у котика – это его уникальный носик для чувствования аромата угощений на дистанции \"полдома\". А ещё это центр харизмы и магнит для нежных поцелуев. Мордочка – это котокомпас, который всегда указывает направление к любви и веселью! да", 
